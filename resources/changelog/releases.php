...
|
| Keys: version, date (Y-m-d or null), status ('coming soon' | 'in testing' | 'released'),
...
return [
    [
        ...
        'changes' => [
            ...
            'Stats by period: today, this week, this month and this year, each against the previous stretch, with a chart to match (Pro).',
            'Year in review: a shareable card of the year, leading the Stats page from 20 December to the end of January (Pro).',
            'Clear speech and boost: a voice filter and up to 12 dB of gain for quiet recordings (Pro).',
            'Up next: queue a book to play after this one, or continue a series automatically (Pro).',
            'Chapter trims: skip the edges of every chapter and short credits chapters, per book (Pro).',
            'Home-screen widgets: continue listening, and the streak (Pro).',
            'Backup and restore to a single file, matched to your library on a new phone (Pro).',
            'Themes: light, dark, accent colours and colours from your wallpaper, plus eleven app icons (Pro).',
            'Achievements arrive as a quiet notification instead of a dialog, and every one of the 56 has its own drawn icon.',
            'Library cards show reading progress in grid view as well as list view.',
