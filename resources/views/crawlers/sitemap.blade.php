...
@foreach (['pro', 'audiobookshelf', 'transcripts', 'formats', 'android-auto', 'sync-protocol', 'compare', 'compare.smart-audiobook-player', 'compare.audiobookshelf-app', 'compare.audible'] as $name)
