    ...
    <div class="container guide-grid">
        ...
        <aside class="guide-aside">
            ...
            <div class="info-card">
                <h3>More guides</h3>
                <ul class="guide-list">
                    @foreach (['audiobookshelf' => 'Audiobookshelf', 'transcripts' => 'Transcripts', 'formats' => 'Formats and chapters', 'android-auto' => 'Android Auto', 'librivox' => 'LibriVox', 'sync-protocol' => 'Sync protocol', 'pro' => 'Kithara Pro', 'howto.audiobookshelf-setup' => 'Set up Audiobookshelf', 'howto.m4b-chapters' => 'Add chapters to an m4b', 'howto.leaving-audible' => 'Leaving Audible', 'compare' => 'Comparisons', 'changelog' => 'Changelog'] as $name => $label)
